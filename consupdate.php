...
$sql = "UPDATE consultation set employeeId = '$employeeId', petnum = '$petnum', dateconsult = '$dateconsult', fees = '$fees', petcondition = '$petcondition', diseaseid = '$diseaseid', injuryid = '$injuryid', vcomment = '$vcomment' 
